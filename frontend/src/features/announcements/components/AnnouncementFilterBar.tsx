    ...
    <div className="flex flex-col sm:flex-row sm:items-center gap-2.5">
      <div className="relative w-full sm:w-56">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2 rounded-xl border border-border bg-bg text-sm text-text-primary placeholder-text-muted focus:ring-1 focus:ring-[#00C8FF] focus:border-[#00C8FF] focus:outline-none transition"
        />
      </div>
      <select
        value={category}
        onChange={(e) => onCategoryChange(e.target.value as 'all' | AnnouncementCategory)}
        className="px-3 py-2 rounded-xl border border-border bg-bg text-sm text-text-primary focus:ring-1 focus:ring-[#00C8FF] focus:border-[#00C8FF] focus:outline-none transition sm:w-40"
      >
